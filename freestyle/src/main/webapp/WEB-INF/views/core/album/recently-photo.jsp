		...
		<!-- InstanceBeginEditable name="content" -->            
                <div class="album-list-main">
                    ...
                    <div class="album-list-bar">
                        <ul id="album-tab">
                            <li><a class="a-b-t" href="#">最近照片</a></li>
                        </ul>
	                            ...
	                            <li class="album-box">
	                                ...
	                                <div class="album-info">	
	                                    ...
	                                    <span class="album-limit" id="">
	                                    	<fmt:formatDate value="${photo.createdTime}" timeZone="GTM+8" pattern="yyyy-MM HH:mm"/>
	                                    </span>
	                                </div>
	                            </li>
                            </c:forEach>
