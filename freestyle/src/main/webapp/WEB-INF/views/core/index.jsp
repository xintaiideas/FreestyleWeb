...
<head>
	...
	<link rel="stylesheet" style="text/css" href="${staticPath}/core/css/mood-upload.css" />
	...
	<script type="text/javascript" src="${staticPath}/core/js/mood-upload.js"></script>
...
<body>
    ...
    <div class="g-sd">
        <ul class="nav">
        	<li>
            	<a class="app-link" href="${ctx}/index">
    ...
    <div class="g-mn" style="overflow-y:scroll;">
            ...
            <div class="frame-nav-inner">
                ...
                <!-- InstanceBeginEditable name="frameNav" -->
                    <li class="fd-nav-item fd-nav-item-list fd-nav-cur-item">
                        <a class="fd-nav-filter" href="#" onclick="return false;">新鲜事</a>
                    </li>
                </ul>
            </div>
        </div>
        <div class="bd-main">
			...
			<div class="a-feed" id="mood-publish-board">
	        	<div class="clearfix header">
	            	<div class="input-container clearfix" style="float: left;width: 400px;margin-left: 60px;">
	            		<div contenteditable="true" class="mood-input" id="mood-input" style="width:380px;height:36px;">说点什么吧</div> 
	            	</div>
	            	<div class="user-avatar" >
	        			<a target="_blank" href="javascript:void(0)" class="avatar">
	        			<c:if test="${account.headImgId eq null}">
	        				<img src="${staticPath}/core/image/men_tiny.gif" width="50" title="${account.realname}">
						</c:if>
						<c:if test="${account.headImgId ne null}">
							<img src="${ctx}/head-image" width="50" title="${account.realname}">
						</c:if>
	            		</a>
	            	</div>
	        	</div>
	        	<div class="own-reply clearfix" style="padding:0px;">
		            <ul class="btn-mood-ul clearfix">
		            	<li id="li-photo" class="li-photo">传照片</li>
		            	<li id="li-video" class="li-video">传视频</li>
		            	<li id="li-publish" class="li-publish">发表</li>
		            </ul>
		            <div id="upload-board" class="upload-board" style="height:370px;overflow:hidden;display:none;">
		            	<div id="wrapper">
						    <div id="container">
						        <!--头部，相册选择和格式选择-->
        	...
        	<c:forEach items="${moods.rows}" var="mood">
		        <div class="a-feed" style="position:relative;">
		        	<c:if test="${user.userId eq mood.accountId}">
				          	...
				          	<div id="comment_id_${comment.id}" commentId="${comment.id}" class="a-reply clearfix">
								...
								<div class="reply-content">
									<p class="reply-info clearfix"> 
							            <a href="javascript:void(0)" target="_blank" class="user-name">${comment.commentor}</a>
