	...
	<form class="layui-form" action="${ctx}/person-info" method="post">
	  <div class="layui-form-item">
	    ...
	    <div class="layui-input-block">
	      <input type="text" name="remark" required lay-verify="required" placeholder="请输入分组名称" autocomplete="off" class="layui-input">
	    </div>
	  </div>
	  <div class="layui-form-item">
...
layui.use('form', function(){
  ...
  form.on('submit(formDemo)', function(data){
    ...
    $.post('${ctx}/friend/add-friend',data.field,function(r) {
    	if(r.code == 'OK') {
    		...
    		if(parent.$('#linkAddFriend').length) {
    			parent.$('#linkAddFriend').text(' (已添加好友 )');
    			parent.$('#linkAddFriend').attr('href','javascript:void(0)');
    		}
    	}else {
