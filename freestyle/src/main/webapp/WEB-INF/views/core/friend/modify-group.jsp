	...
	<form class="layui-form" action="${ctx}/person-info" method="post">
	  <div class="layui-form-item">
	    ...
	    <div class="layui-input-block">
	      <input type="text" name="name" required lay-verify="required" value="${group.name}" placeholder="请输入分组名称" autocomplete="off" class="layui-input">
	    </div>
	  </div>
	  <div class="layui-form-item">
	    <div class="layui-input-block">
...
layui.use('form', function(){
  ...
  form.on('submit(formDemo)', function(data){
	data.field.groupId = '${group.id}';
    $.post('${ctx}/friend/modify-group',data.field,function(r) {
    	if(r.code == 'OK') {
